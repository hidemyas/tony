...
<div id="header_info" style="opacity:0">
    <nav class="header-nav reveal"> <a class="top1 header-logo" style="text-decoration:none;" href="<?php echo site_url() ?>">Arşiv Sayfası</a>

        <p class="top2 lead archive-p">Yıl ve aya göre arşivlenen makaleler</p>
        <div class="btn-group" style="margin-top: -145px;margin-left: 180px;">
            <button type="button" class="btn btn-primary"><a href="<?php echo site_url() ?>" style="text-decoration:none;color:white"><i class="czs-hand-slide" style="margin-right:5px" ></i> Ana Sayfaya geri dön</a>
            </button>
        </div>
    </nav>
