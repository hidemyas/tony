...
<body id="body">
        ...
        <header class="tony-header-fixed" id="header-div">
            <?php if (is_single()) { ?>
                <div class="header-div1">
                    ...
                    <a style="margin-top: 12px;margin-left: 12px;"><button onclick="open_search();" type="button" class="btn btn-light" style="letter-spacing: 1px;font-weight: 500;">Arama</button></a>
                </div>
            <?php } else { ?>
            ...
            <div class="header-div2">
                <a href="<?php echo site_url() ?>"><button type="button" class="btn btn-light" style="letter-spacing: 1px;font-weight: 500;">Anasayfa</button></a>
    ...
    <div id="view-div" class="center-info" style="display:none">
        <p id="view-text">-&nbsp;<?php if (!is_single() && !is_page()) echo 'Makale Listesi';else echo get_the_title(); ?>&nbsp;-</p>
    </div>
    ...
    <div id="search_form" class="search_form_dis">
        ...
        <div class="search-bg" id="search-div">
            <div class="search-div1">
                ...
                <p>Bu sitedeki tüm içeriklerden ihtiyacınız olanı bulun</p>
